          ...
          Container(
            ...
            child: Container(
              decoration: const BoxDecoration(
                border: Border(
                  bottom: BorderSide(
                    color: Color(0xFFC4A8E8), // Brighter purple border
                    width: 2,
                  ),
                ),
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // MANSAKA title with minimal container
                      Container(
  ...
  Widget _buildInfoCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: const Color(0xFFC4A8E8).withOpacity(0.3), // Brighter purple border
          width: 1,
        ),
      ),
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xFFC4A8E8).withOpacity(0.2), // Brighter purple accent
              borderRadius: BorderRadius.circular(8),
            ),
            child: Icon(
              icon,
              color: const Color(0xFFC4A8E8), // Brighter purple icon
              size: 18,
            ),
          ),
          ...
          Text(
            ...
            style: const TextStyle(
              color: Color(0xFFC4A8E8), // Brighter purple label
              fontSize: 8,
        ...
        const Padding(
          ...
          child: Row(
            children: [
              Icon(
                Icons.explore,
                color: Color(0xFFC4A8E8), // Brighter purple color
                size: 20,
              ),
              SizedBox(width: 8),
              Text(
